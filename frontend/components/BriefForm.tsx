...
export default function BriefForm({ onBriefGenerated, onError, loading, setLoading }: BriefFormProps) {
    ...
    <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-md p-6">
      ...
      <div className="mb-4">
        ...
        <select
          ...
          onChange={(e) => setFormData({ ...formData, content_type: e.target.value as BriefRequest['content_type'] })}
          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
          disabled={loading}
        >
      ...
      <div className="mb-4">
        ...
        <select
          id="tone"
          value={formData.tone}
          onChange={(e) => setFormData({ ...formData, tone: e.target.value as BriefRequest['tone'] })}
          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
          disabled={loading}
        >

    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row gap-4 p-6 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl border border-indigo-100">
        <div className="flex-1">
          <h3 className="font-semibold text-gray-900 mb-1">Ready to create your article?</h3>
          <p className="text-sm text-gray-600">Your brief is ready. Generate a full article or copy the brief for later use.</p>
        </div>
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          <div className="p-4 bg-gray-50 rounded-lg border border-gray-100">
            <h3 className="text-sm font-semibold text-gray-700 uppercase tracking-wider mb-2">Article Title</h3>
            <p className="text-lg font-semibold text-gray-900">{brief.title}</p>
          </div>

          <div className="p-4 bg-gray-50 rounded-lg border border-gray-100">
            <h3 className="text-sm font-semibold text-gray-700 uppercase tracking-wider mb-2">Meta Description</h3>
        ...
        {/* Outline */}
        <div>
          <h3 className="text-lg font-bold text-gray-900 mb-4">Content Outline</h3>
          <div className="space-y-3">
            {brief.outline.map((section, index) => (
              <div key={index} className="border border-gray-200 rounded-lg overflow-hidden hover:border-indigo-200 transition-colors">
                <button
        ...
        {/* Recommendations */}
        <div>
          <h3 className="text-lg font-bold text-gray-900 mb-4">Writing Recommendations</h3>
          <div className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-lg p-5 border border-purple-100">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-gray-900 capitalize">{brief.recommendations.tone}</p>
              </div>
              <div>
                <p className="text-sm font-semibold text-gray-700 mb-1">Style</p>
                <p className="text-gray-900 capitalize">{brief.recommendations.style}</p>
              </div>
            </div>
          </div>
        </div>
